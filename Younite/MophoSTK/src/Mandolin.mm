  ...
  : PluckTwo( lowestFrequency )
{
  ...
  soundfile_[0] = new FileWvIn(  [[[NSBundle mainBundle] pathForResource:@"mand1" ofType:@"raw"] UTF8String], true );
  soundfile_[1] = new FileWvIn(  [[[NSBundle mainBundle] pathForResource:@"mand2" ofType:@"raw"] UTF8String], true );
  soundfile_[2] = new FileWvIn(  [[[NSBundle mainBundle] pathForResource:@"mand3" ofType:@"raw"] UTF8String], true );
  soundfile_[3] = new FileWvIn(  [[[NSBundle mainBundle] pathForResource:@"mand4" ofType:@"raw"] UTF8String], true );
  soundfile_[4] = new FileWvIn(  [[[NSBundle mainBundle] pathForResource:@"mand5" ofType:@"raw"] UTF8String], true );
  soundfile_[5] = new FileWvIn(  [[[NSBundle mainBundle] pathForResource:@"mand6" ofType:@"raw"] UTF8String], true );
  soundfile_[6] = new FileWvIn(  [[[NSBundle mainBundle] pathForResource:@"mand7" ofType:@"raw"] UTF8String], true );
  soundfile_[7] = new FileWvIn(  [[[NSBundle mainBundle] pathForResource:@"mand8" ofType:@"raw"] UTF8String], true );
  soundfile_[8] = new FileWvIn(  [[[NSBundle mainBundle] pathForResource:@"mand9" ofType:@"raw"] UTF8String], true );
  soundfile_[9] = new FileWvIn(  [[[NSBundle mainBundle] pathForResource:@"mand10" ofType:@"raw"] UTF8String], true );
  soundfile_[10] = new FileWvIn( [[[NSBundle mainBundle] pathForResource:@"mand11" ofType:@"raw"] UTF8String], true );
  soundfile_[11] = new FileWvIn( [[[NSBundle mainBundle] pathForResource:@"mand12" ofType:@"raw"] UTF8String], true );
...
void Mandolin :: pluck( StkFloat amplitude, StkFloat position )
{
  ...
  if ( position < 0.0 ) {
    NSLog(@"Mandolin::pluck: position parameter less than zero ... setting to 0.0!");
    handleError( StkError::WARNING );
    pluckPosition_ = 0.0;
  }
