#ifndef STK_ENVELOPEFOLLOWER_H
#define STK_ENVELOPEFOLLOWER_H
...
namespace stk {
	...
	class EnvelopeFollower : public Filter
		...
		public:
			...
			EnvelopeFollower( StkFloat decayRate = 60.0 );
			
			//Set the decay rate of the follower in dB
			void setDecayRate(StkFloat decayRate);
	...
	inline StkFloat EnvelopeFollower :: tick( StkFloat input )
	{
	...
	inline StkFrames& EnvelopeFollower :: tick( StkFrames& frames, unsigned int channel )
	{
	...
	inline StkFrames& EnvelopeFollower :: tick( StkFrames& iFrames, StkFrames& oFrames, unsigned int iChannel, unsigned int oChannel )
	{
#if defined(_STK_DEBUG_)
